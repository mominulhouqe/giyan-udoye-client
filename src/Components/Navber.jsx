    ...
    <div className="sticky top-0 w-full z-20 bg-[#D2B48C] shadow-lg">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="hidden md:flex flex-grow justify-center items-center space-x-4 text-white">
          <Menu
            mode="horizontal"
            className="bg-transparent md:ml-10 w-full border-0 text-white text-lg font-semibold"
          >
        ...
        <Menu mode="vertical" className="border-0 text-lg">
          ...
          <Menu.Item key="auth" onClick={toggleDrawer}>
            {user ? (
              <Button
                type="primary"
                className="bg-red-500 border-0 hover:bg-red-600 w-full"
                onClick={handleLogout}
              >
                Logout
              </Button>
              ...
              <Link to="/login">
                <Button
                  type="primary"
                  className="bg-green-500 border-0 hover:bg-green-600 w-full"
                >
                  Login
                </Button>
              </Link>
